...
class Public_Areas extends Conexion {
	private $area_flga = "";  private $loc_id = 0;  private $area_parent = "NULL";  private $area_nombre = "";  private $area_abrev = "";  private $area_siglas = "";
	...
	private $parent_key = "";  private $loc_key = "";

	public function setArea_flga($val)    { $this->area_flga = $val; }
	public function getArea_flga()        { return $this->area_flga; }

	public function setLoc_id($val)       { $this->loc_id = $val; }
	public function getLoc_id()           { return $this->loc_id; }
	...
	public function setLoc_key($val){ $this->loc_key = $val; }
	public function getLoc_key(){ return $this->loc_key; }
	...
	public function actualiza() {
		...
		$this->sql = "SELECT areas_update(
						'$this->type_edit', '$this->area_key', '$this->loc_key', '$this->parent_key', '$this->area_nombre', '$this->area_abrev', '$this->area_siglas',
						 $this->area_fechaini, $this->area_fechafin, '$this->area_observ', $this->area_estado, '$this->usursess_key', '$this->menu_id')";
		//echo $this->sql;
	...
	public function registros() {
		$this->sql = "SELECT public.areas_records('o', 
						'$this->area_id', '$this->area_key', '$this->unieje_id', '$this->loc_id', $this->area_parent, '$this->area_nombre', '$this->area_abrev', 
						 $this->tiparea_id, $this->area_estado, '$this->unieje_key', '$this->loc_key', '$this->usursess_key', '$this->menu_id',
