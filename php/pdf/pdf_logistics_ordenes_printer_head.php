...
$this->SetFont('helvetica', 'B', 8);
$this->Cell(109, $_h, $GLOBALS['_ah'][0]['pers_nombre'], 'TR', 0, 'L');
...
$this->Cell(3, $_h, ':', '', 0, 'L');
$this->SetFont('helvetica', '', 8);
$this->Cell(109, $_h, SUBSTR($GLOBALS['_ah'][0]['pers_domicilio'],0,68), 'R', 0, 'L');
$this->Cell(1, $_h, '', 0, 0, 'C');
$this->SetFont('helvetica', 'B', 8);
...
$this->Cell(3, $_h, ':', 'B', 0, 'L');
$this->SetFont('helvetica', '', 8);
$this->Cell(23, $_h, "", 'B', 0, 'L');
$this->SetFont('helvetica', 'B', 8);
$this->Cell(12, $_h, ' Celular', 'B', 0, 'L');
$this->Cell(3, $_h, ':', 'B', 0, 'L');
$this->SetFont('helvetica', '', 8);
$this->Cell(23, $_h, "", 'BR', 0, 'L');
$this->Cell(1, $_h, '', 0, 0, 'C');
$this->SetFont('helvetica', 'B', 8);
...
$this->Cell(1, $_h, '', 0, 0, 'C');
$this->SetFont('helvetica', 'B', 8);
$this->Cell(22, $_h, ' Plazo Entrega', 'LT', 0, 'L');
$this->Cell(3, $_h, ':', 'T', 0, 'L');
$this->SetFont('helvetica', '', 8);
$_plazo_entrega = $GLOBALS['_ah'][0]['orden_plazo'] . ($GLOBALS['_ah'][0]['orden_plazo']*1 > 1 ? ' Días Calendario' : ' Día Calendario');
...
$this->Cell(3, $_h, ':', '', 0, 'L');
$this->SetFont('helvetica', '', 8);
$this->Cell(109, $_h, $GLOBALS['_ah'][0]['fuefin_code'].' '.$GLOBALS['_ah'][0]['fuefin_nombre'], 'R', 0, 'L');
$this->Cell(1, $_h, '', 0, 0, 'C');
$this->SetFont('helvetica', 'B', 8);
...
$this->Cell(3, $_h, ':', 'B', 0, 'L');
$this->SetFont('helvetica', '', 8);
$this->Cell(109, $_h, $GLOBALS['_ah'][0]['tiprecur_code'].' '.$GLOBALS['_ah'][0]['tiprecur_nombre'], 'RB', 0, 'L');
...
$this->eje_y += 5;  $this->fnEstablecerEjes( $this->eje_y, $this->eje_x );  $_h = 5;
...
if ($this->PageNo()*1 > 1 ) {$this->eje_y += 6;  $this->fnEstablecerEjes( $this->eje_y, $this->eje_x );  $_h = 5;}
?>