...
__changeEnabled:true,setChangeEnabled:function(pcChangeEnabled){this.__changeEnabled=pcChangeEnabled;},getChangeEnabled:function(){return this.__changeEnabled;},
setStores:function(pbLoad_pais){
var _cboPais_id=this.down('#pais_id');_cboPais_id.bindStore(Ext.create('Siace.store.pub.PaisesCbo'));
var _cboDpto_id=this.down('#dpto_id');_cboDpto_id.bindStore(Ext.create('Siace.store.pub.DepartamentosCbo'));
var _cboPrvn_id=this.down('#prvn_id');_cboPrvn_id.bindStore(Ext.create('Siace.store.pub.ProvinciasCbo'));
var _cboDstt_id=this.down('#dstt_id');_cboDstt_id.bindStore(Ext.create('Siace.store.pub.DistritosCbo'));
if(pbLoad_pais==true){_cboPais_id.getStore().load({params:{xxType_record:'combo'}});}
}});